...
class CouchDBManager(object):
    ...
    def get_server(self, app):
        """
        There is no way to use authentification for the couchdb server.
        I wrote a quick patch to fix this, here it is. No real documentation for the changes,
        and I made an internal helper function get_server in CouchDBManager which returns a server object.
